...
public class RegistroHuesped extends JFrame {
	...
	public RegistroHuesped() {
		...
		txtNacionalidad.setModel(new DefaultComboBoxModel<>(new String[] { "Selecciona una nacionalidad...","afgano-afgana", "alemán-", "alemana",
		...
		btnguardar.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				if (txtNombre.getText().equals("")) {
					...
					JOptionPane.showMessageDialog(null, "Debe ingresar su fecha de nacimiento");
					txtFechaN.requestFocusInWindow();
					return;
				}else if(txtNacionalidad.getSelectedItem().toString().equals("Selecciona una nacionalidad...")) {
	...
	public void setIdReserva(Integer _idReserva) {
	...
	private void guardarRegistro() {
			...
			ModeloHuesped huesped = new ModeloHuesped(nombre, apellido, fecha, nacionalidad, telefono, idReserva);
			HuespedController huespController = new HuespedController();
			huespController.guardar(huesped);
	}
